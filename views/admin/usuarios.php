...
<body>
    ...
    <nav class="navegacion">
        ...
        <a href="usuarios.php" class="navegacion__enlace navegacion__enlace--activo">Usuarios</a>
    ...
    <table>
        ...
        if($conn) {
            $sql = "SELECT id, nombre, apellido, usuario, correo, password, admin FROM usuarios";
            ...
            while ($row = mysqli_fetch_assoc($resultado)) {
                ...
                echo "<td><button onclick=\"location.href='actualizar_usuario.php?id=".$row['id']."'\" class=\"boton boton-actualizar\">Actualizar</button></td>";
